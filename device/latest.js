...
class Im3xWidget {
    ...
    async renderSmall () {
        ...
        let icon = header.addImage(await this.getImage('https://cdn.nlark.com/yuque/0/2020/png/275318/1583823984630-avatar/057ee447-c081-4e37-bc6c-d1a9628d7dc6.png?x-oss-process=image%2Fresize%2Cm_fill%2Cw_64%2Ch_64%2Fformat%2Cpng'))
        icon.imageSize = new Size(15, 15)
        header.addSpacer(10)
        let title = header.addText("爱回收")
        ...
        var deviceTxt = w.addText(model + "," + deviceName + "," + systemVersion)
